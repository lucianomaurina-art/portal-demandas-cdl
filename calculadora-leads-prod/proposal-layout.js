...
window.generateProposal=async function(){
  ...
  if(currentRequestId){
    ...
    requestCnaes=req?.client?.cnaes_segments||'';
  }
  ...
  const cnaeText=requestCnaes||c?.cnaes_segments||'';
