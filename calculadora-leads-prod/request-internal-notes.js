...
// Carrega a extensão que traz as informações visíveis da proposta para dentro da calculadora.
(() => { const s=document.createElement('script'); s.src='calculator-proposal-notes.js?v=20260916-1'; document.head.appendChild(s); })();