...
(() => {
  ...
  const originalReset=window.resetSelection;if(typeof originalReset==='function')window.resetSelection=function(){const r=originalReset.apply(this,arguments);sync();return r};
